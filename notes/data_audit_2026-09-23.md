...
PASS  2026 raw: 32 unique boxscores (weeks 1-2)
PASS  2026 raw: zero ERR lines
PASS  2026 raw: all P lines have 18 fields
PASS  2026 raw: no duplicate (game,player) rows — 0 dups
PASS  2026 logs rows == raw P lines — 636 vs 636
PASS  2026 coverage: every team has all its scheduled games in scraped weeks — min 2 max 2
PASS  2026 coverage: 64 team-games — 64
...
PASS  2026 dvp_weekly rows = 64 — 64
PASS  2026 independent recompute of all 2176 weekly cells — 0 mismatches
...
PASS  2026 D/ST rows match raw D lines — 5 vs 5
PASS  2026 D/ST totals match
PASS  dashboard payload == dvp_combined.csv (2176 cells) — 0 off
PASS  dashboard logs == game_logs rows (11338) — 11338
PASS  dashboard weekly == 1152 defense-weeks — 1152
